    ...
    <v-app-bar color="#161880" class="pt-3" height="fit-content" absolute>
      <v-container>
        ...
        <v-row class="mt-6">
          <v-col cols="5">
            <ul
              class="links d-flex text-white justify-space-around"
          ...
          <v-col cols="2"></v-col>
          <v-col cols="5" style="gap: 35px" class="d-flex justify-end">
            <div
            ...
            <div
              class="help d-flex align-center text-white"
              style="list-style: none; gap: 5px"
              @click="$emit('openCurrConvertForm')"
            >
              <img src="@/assets/SVGS/currency.svg" style="width: 25px" />
              <span>Currency</span>
            </div>
            <div
              ...
              id="lang-btn"
            >
              <img :src="selectedLang[0].icon" style="width: 20px" />
              <span
